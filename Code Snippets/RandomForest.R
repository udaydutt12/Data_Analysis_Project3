...
# Fitting a Random Forest for Performing Classification
...
# The model reports that `mtry=3`, which is the number of variables randomly chosen at each split.
# The mis-classification rate of the training data is about 17%.
