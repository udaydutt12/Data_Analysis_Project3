...
# In order to conduct principal component analysis, we have removed categorical variables 
# in our model and made a new data that consists of continuous variables only. The PCA plot
# confirms that the standard deviation and the variance was the highest for PC1. And thus,
# PC1 is more important.
