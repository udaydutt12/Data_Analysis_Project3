...
# Use ROC Curve for determining 'threshold'
library(ROCR)
...
# The Logistic regression model on the 'phd' variable had a prediction efficiency of about 86%.
# From the training data set using about 70% of the total dataset, prediction efficiency was 81%.
# Then ROC curve over the logistic regression indicates true positive rate of about 85%.
